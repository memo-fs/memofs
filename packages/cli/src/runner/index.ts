...
import { registerConnectorsCommands } from "./connectors";
...
export { registerConnectorsCommands } from "./connectors";
export { registerGenerateCommands } from "./generate";
export { registerMemoryCommands } from "./memory";
export type { CLIContext } from "./shared";
export { collect, parseScope } from "./shared";
...
export function registerAllCommands(program: Command, ctx: CLIContext) {
	...
	registerGenerateCommands(program, ctx);
	registerAgentCommands(program, ctx);
	registerConnectorsCommands(program, ctx);
	registerCloudCommands(program, ctx);
