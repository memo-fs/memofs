...
memofs --cloud-url https://cloud.memofs.dev/api/v1 --api-key mfs_live_... cloud health

# Via environment variables (preferred)
export MEMOFS_CLOUD_URL="https://cloud.memofs.dev/api/v1"
export MEMOFS_API_KEY="mfs_live_..."
memofs cloud health
```
