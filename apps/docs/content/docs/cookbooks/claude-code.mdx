...
1. Install the adapter:
   <Tabs items={["npm", "pnpm", "bun", "deno"]}>
     <Tab value="npm">
   ```bash
   npm install -D @memofs/adapter-transformers
   ```
     </Tab>
     <Tab value="pnpm">
   ```bash
   pnpm add -D @memofs/adapter-transformers
   ```
     </Tab>
     <Tab value="bun">
   ```bash
   bun add -d @memofs/adapter-transformers
   ```
     </Tab>
     <Tab value="deno">
   ```bash
   deno add -D npm:@memofs/adapter-transformers
   ```
     </Tab>
   </Tabs>
