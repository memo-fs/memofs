...
AgentFS is the virtual filesystem layer built into the `@memofs/core` runtime. It provides autonomous AI agents with an isolated workspace for task execution, scaffolding, file manipulation, and automated durable-memory extraction.
...
## The Virtual Path Contract (`MemoryStore`)
...
## Client API Reference (`memofs.agentfs`)
...
## Advisory Leases (`withMemoryLease`)
