					...
					<div className="group relative flex flex-col justify-between p-8 transition-colors hover:bg-muted/60">
						<div>
							<div className="flex items-center justify-between">
								...
								<span className="font-mono text-[10px] text-amber-600 dark:text-amber-300 border border-amber-300 dark:border-amber-500/30 px-2 py-0.5 bg-amber-50 dark:bg-amber-950/20">
									Cloud Sync
								</span>
							</div>
					...
					<div className="group relative flex flex-col justify-between p-8 transition-colors hover:bg-muted/60">
						<div>
							<div className="flex items-center justify-between">
								...
								<span className="font-mono text-[10px] text-cyan-700 dark:text-cyan-300 border border-cyan-300 dark:border-cyan-500/30 px-2 py-0.5 bg-cyan-50 dark:bg-cyan-950/20">
									Zero Local Files
								</span>
							</div>
