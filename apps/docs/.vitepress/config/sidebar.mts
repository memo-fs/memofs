	...
	"/api/": [
		{
			...
			items: [
				...
				{ text: "@tekmemo/core", link: "/api/core" },
				{ text: "@tekmemo/server", link: "/api/server" },
				{ text: "@tekmemo/mcp-server", link: "/api/mcp-server" },
				{ text: "@tekmemo/connectors", link: "/api/connectors" },
			],
		},
	],
};
