			...
			<div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
				...
				<div className="mt-8 flex flex-wrap items-center justify-center gap-4">
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						className="inline-flex h-10 items-center justify-center rounded border border-cyan-600/40 bg-cyan-50 hover:bg-cyan-100 dark:border-zinc-800 dark:bg-zinc-950 dark:text-cyan-400 dark:hover:border-cyan-500/50 dark:hover:bg-cyan-950/20 px-5 text-sm font-medium transition-colors"
					>
						MemoFS Cloud
					</a>
				</div>
