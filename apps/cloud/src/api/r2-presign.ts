...
import { DEFAULT_PRESIGN_TTL_SECONDS } from "../server/env";
...
export function presignConfigFromEnv(env: CloudWorkerEnv): R2PresignConfig {
	return {
 ...
 *                `9f86d081884c7d65…`. Never the canonical `.tekmemo/` path —
