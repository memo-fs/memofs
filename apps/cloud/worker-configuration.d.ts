/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudWorkerEnv` (hash: e6b67dbaf9ee75b578b24469664d0543)
// Runtime types generated with workerd@1.20260617.1 2026-06-20 nodejs_compat
interface __BaseEnv_CloudWorkerEnv {
	BLOBS: R2Bucket;
	ASSETS: Fetcher;
	ENVIRONMENT: "development";
	CLOUD_PUBLIC_BASE_URL: "http://localhost:8787";
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_CloudWorkerEnv {}
}
interface CloudWorkerEnv extends __BaseEnv_CloudWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "CLOUD_PUBLIC_BASE_URL" | "PRESIGN_TTL_SECONDS" | "R2_S3_ENDPOINT" | "R2_BUCKET_NAME">> {}
}
