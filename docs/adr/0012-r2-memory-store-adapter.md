...
## Amendment — 2026-07-04 reconciliation (K1, S3-Q3 decoupling)
...
This ADR's original decision held the R2 **blob** implementation and the Turso
**metadata** implementation together in one adapter package. The reconciliation's
...
- Code: `packages/core/src/fs/node-fs-memory-store.ts` (the `MemoryStore`
...
- Reconciliation (2026-07-02): [`docs/architecture/reconciliation-2026-07-02.md`](../architecture/reconciliation-2026-07-02.md)
  — K1 + S3-Q3 govern the blob/metadata decoupling.
